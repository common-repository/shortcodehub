...
if ( ! class_exists( 'Sh_Shortcode_Type_Query_Simple_Grid' ) ) :
	 ...
	 * @since 1.2.0
	 */
	class Sh_Shortcode_Type_Query_Simple_Grid {
		...
		public function __construct() {
			add_action( 'sh_shortcode_markup_simple-grid', array( $this, 'shortcode_markup' ) );
		...
		function enqueue_assets() {
			...
			wp_register_style( 'sh-layout-grid', sh_get_plugin_uri( __FILE__ ) . 'css-static.css', null, sh_get_product_version(), 'all' );
		}
		...
		function shortcode_markup( $post_id ) {
			...
			wp_enqueue_style( 'sh-layout-grid' );
			...
			do_action( 'sh_shortcode_markup_simple-grid-before', $post_id, $args );
			...
			do_action( 'sh_shortcode_markup_simple-grid-after', $post_id, $args );
		}
	 ...
	 */
	Sh_Shortcode_Type_Query_Simple_Grid::get_instance();
