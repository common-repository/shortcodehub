...
class TextHelper {
	...
	public static function trim_words( $text, $num_words = 55, $more = null, $allowed_tags = 'p a span b i br blockquote' ) {
		...
		if ( 'characters' == _x( 'words', 'word count: words or characters?', 'shortcodehub' ) && preg_match( '/^utf\-?8$/i', get_option( 'blog_charset' ) ) ) {
